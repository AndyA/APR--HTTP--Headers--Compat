...
$variants = [
  [
    'var1', 0.950, 'text/plain', [ 'uuencode', 'compress' ],
    'iso-8859-2', 'se', 400
  ],
  [
    'var2',       1.000, 'text/html;version=2.0', 'gzip',
    'iso-8859-1', 'en',  3000
  ],
...
$request->header( 'Accept',
  'text/plain; q=0.55, image/gif; mbx=10000' );
...
@a = choose( $variants, $request );
show_res( @a );
expect( \@a, [ [ 'var2' => 0.25 ], [ 'var1' => 0 ], [ 'var3' => 0 ] ] );
...
$variants = [
  ...
  [
    'provoke-warning', undef, undef, undef, undef, 'x-no-content-type',
    undef
  ],
];
...
$variants = [
  [
    'Canadian English' => 1.0,
    'text/html', undef, undef, 'en-CA', undef
  ],
